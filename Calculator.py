...
root.geometry("381x381+500+200")
val=""
data=StringVar()
display=Entry(root,textvariable=data,bd=29,justify="right",bg="blue",font=("ariel",20))
...
btn_add=Button(root,text="+",font=("Ariel",12,"bold"),bd=12,height=2,width=4,command=lambda:btnClick("+"))
...
btn_sub=Button(root,text="-",font=("Ariel",12,"bold"),bd=12,height=2,width=4,command=lambda:btnClick("-"))
...
btn_mul=Button(root,text="X",font=("Ariel",12,"bold"),bd=12,height=2,width=4,command=lambda:btnClick("*"))
btn_mul.grid(row=3,column=3)
btn0=Button(root,text="0",font=("Ariel",12,"bold"),bd=12,height=2,width=4,command=lambda:btnClick(0))
btn0.grid(row=4,column=0)
btn_C=Button(root,text="C",font=("Ariel",12,"bold"),bd=12,height=2,width=4,command=btnclear)
btn_C.grid(row=4,column=1)
btn_eql=Button(root,text="=",font=("Ariel",12,"bold"),bd=12,height=2,width=4,command=btneql)
